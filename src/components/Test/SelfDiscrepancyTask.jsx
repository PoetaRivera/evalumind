  ...
  return (
    <div style={{ maxWidth: '650px', margin: '0 auto' }}>
      <div style={{ marginBottom: '24px', textAlign: 'center' }}>
        <h2 style={{ fontSize: '1.2rem', color: '#1a1a2e', marginBottom: '8px' }}>
        ...
        {ratings.map((r, i) => (
          <div key={r.trait} style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#1a1a2e' }}>{r.trait}</span>
            </div>
            ...
            <div style={{ display: 'flex', gap: '16px' }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2px' }}>
                  <span style={{ fontSize: '0.7rem', color: '#4a90d9' }}>Muestro</span>
                  <span style={{ fontSize: '0.75rem', fontWeight: 600, color: '#4a90d9' }}>
                    {r.publicSelf || '?'}
                  </span>
                </div>
                <input
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2px' }}>
                  <span style={{ fontSize: '0.7rem', color: '#8b5cf6' }}>Realmente soy</span>
